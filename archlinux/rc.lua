...
keybinding({ modkey,"Control" }, "f", function () awful.util.spawn(brower) end):add()
keybinding({ modkey,"Control" }, "p", function () awful.util.spawn(pdfviewer) end):add()
keybinding({ modkey,"Control" }, "o", function () awful.util.spawn(fm) end):add()
